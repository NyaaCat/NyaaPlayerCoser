...
public class RunCommandUtils {
    ...
    public static void executeCommand(Player player, String command, String commandPermission) {
        ...
        if (permission.equals("*")) {
            ...
            List<PermissionAttachment> permissionAttachmentList = attachPermission(player, permission);
            try {
                player.performCommand(cmd);
            } finally {
    ...
    @Nullable
    public static List<PermissionAttachment> attachPermission(Player player, String permissions) {
        ...
        for (String permission : permissionList) {
            ...
            PermissionAttachment attachment = player.addAttachment(NyaaPlayerCoser.instance, 1);
